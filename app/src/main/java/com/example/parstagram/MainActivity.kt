...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 3. imageview to show the picture the user took
        // 4. button to save and send the post to the parse server

        findViewById<Button>(R.id.sendPictureBtn).setOnClickListener {
